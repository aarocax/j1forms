...
const Transiciones: Transition = {
    ...
    Tab5: { next: 'Tab6', previous: 'Tab4', conditions: { next: () => true, previous: () => true } },
    Tab6: { next: 'Tab7', previous: 'Tab5', conditions: { next: () => true, previous: () => true } },
    Tab7: { next: 'Tab7', previous: 'Tab6', conditions: { next: () => true, previous: () => true } },
};
